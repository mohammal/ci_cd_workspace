...
<form:form commandName="FunctionAppBean" action="/jsw-report/mainController/submitNumberOfCases">				
				<table
...
function getCaseStudiedTable(thisVariable){
    ...
    $.ajax({                    
    	  url: '/JSW/NW/getCaseCreatedCompany/'+firstColumnValue+"@"+secondColumnValue,     
    	  type: 'GET',
    	async:false,
    	cache:false,
