...
<nav class="w3-sidenav w3-text-white w3-collapse w3-Indigo w3-animate-left"
...
<p class="w3-right w3-hide" onClick="openchat()" id="myChatLogo">
	...
	<div class="w3-container">
		...
		<img src="<c:url value='/img/jsw.png'/>"
			style="width:100%;height: 15%" id="img" class="w3-round w3-white" ><br>
		</center><br>
	...
	<div class="w3-dropdown-hover">
		<a href="${parentMenu.href}" 
			...
			<div  class="w3-dropdown-content w3-Indigo w3-animate-zoom w3-right w3-padding w3-medium">
	...
	<div class="dropdown-content w3-Indigo w3-animate-zoom w3-right w3-padding w3-medium">
