			...
			<div id="myTableList">
				<div class="w3-container">
					...
					<h3 class="w3-text-blue">
						<b>Number of Cases Completed</b>
					</h3>
				</div>
 
<form:form commandName="FunctionAppBean" action="/jsw-report/mainController/submitNumberOfCasesCompletedHR">				
				<table
 ...
 <table
					...
					<thead>
						<b><tr class="w3-text-white w3-blue w3-center w3-medium">
							...
							<td class="w3-center">Step Name</td>
...
function getCaseStudiedTable(thisVariable){
    ...
    $.ajax({                    
    	  url: '/jsw-report/NW/getCaseCreatedCompanyCompletedHR/'+firstColumnValue,     
    	  type: 'GET',
    	async:false,
    	cache:false,
