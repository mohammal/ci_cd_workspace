...
<form:form commandName="FunctionAppBean" action="/jsw-report/mainController/submitNumberOfCasesCompletedAR">				
				<table
...
function getCaseStudiedTable(thisVariable){
    ...
    $.ajax({                    
    	  url: '/jsw-report/NW/getCaseCreatedCompanyCompletedAR/'+firstColumnValue,     
    	  type: 'GET',
    	async:false,
    	cache:false,
