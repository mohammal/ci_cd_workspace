			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${approverList}">
							<tr class="">

								<td>${list.id}</td>
								<td>${list.userName}</td>
								<td>${list.approverName}</td>
								<td>${list.backupName}</td>


								<td><a href="/jsw-report/mainController/editApprover/${list.id}"
									class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a></td>
								<td><a
									href="/jsw-report/mainController/deleteApprover/${list.id}"
									class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/mainController/addApprover">
