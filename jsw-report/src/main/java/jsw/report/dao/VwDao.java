...
public interface VwDao {
	...
	// Payment, Delivery,Order,Invoice
...
//AP	
	...
	/*
	 * public boolean updateRole(Role role) throws SQLException; public Role
	 * editRole(int id) throws SQLException; public boolean deleteRole(int id)
	 * throws SQLException;
	 */
	// ***********End
