			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${FunctionManagementList}">
							<tr class="">
								...
								<td><a href="/DessaultAviation/POC/editfunction/${list.id}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/DessaultAviation/POC/deletefunction/${list.id}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/DessaultAviation/POC/addfunction">
